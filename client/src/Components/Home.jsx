...
function Home() {
    ...
    <section className="container mt-3 mb-3 border-bottom border-top">
      ...
      In High School Skyler started to fix guitars up for money. This led to an entrepreneurial passion, that became Hummingbird Guitars.</p>
      <p>There is a myth that if a hummingbird stops moving they die. To pursue their dreams Skyler did not stop working on guitars, almost every second of their day was spent working on guitars at one point. They never stopped moving. This work ethic lent itself to the name Hummingbird Guitars.</p>
