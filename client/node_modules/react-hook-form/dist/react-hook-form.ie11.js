...
function FormContext(props) {
    ...
    var errors = rest.errors, formState = rest.formState;
    return React.useMemo(function () { return (React.createElement(FormGlobalContext.Provider, { value: rest }, children)); }, [errors, formState]);
}
